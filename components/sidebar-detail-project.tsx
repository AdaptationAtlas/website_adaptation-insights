    ...
    <div className='p-5'>
      ...
      <div className='mb-10'>
        <ul>
          ...
          <li className='flex items-center'>
            ...
            <p className='font-semibold'>6,000,000 CHF</p>
          </li>
          <li className='flex items-center'>
            <h4 className='w-32 mr-3 text-sm font-semibold'>Date</h4>
            <p>2017-2020<span className='text-brand-burgundy text-xs font-semibold ml-2'>Completed</span></p>
          </li>
        </ul>
      </div>
      ...
      <div className='mb-8'>
        ...
        <div className='flex items-baseline mb-4'>
          <h3 className='w-32 mr-3 text-sm font-semibold uppercase'>300,000 beneficiaries</h3>
          <ul>
      ...
      <div className='mb-8'>
        ...
        <div className='mb-4'>
          <h3 className='text-sm font-semibold uppercase mb-1'>2 project partners</h3>
          <ul>
            <li className='mb-1'>Item</li>
          </ul>
        </div>
        <div className='mb-4'>
          <h3 className='text-sm font-semibold uppercase mb-1'>1 funding partner</h3>
          <ul>
            <li className='mb-1'>Women</li>
            <li className='mb-1'>Youth</li>
          </ul>
        ...
        <div className='mb-4'>
          <h3 className='text-sm font-semibold uppercase mb-1'>5 implementation partners</h3>
          <ul>
            <li className='mb-1'>Item</li>
            <li className='mb-1'>Item</li>
          </ul>
