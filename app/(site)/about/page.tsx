...
export default async function About() {
  ...
  return (
    <div className='relative pt-[70px]'>
      ...
      <div className='max-w-[960px] mx-auto mb-[100px]'>
        <h2 className='text-[42px] text-grey-700 font-bold tracking-wide leading-tight mb-8'>Objectives</h2>
        ...
        <h2 className='text-[42px] text-grey-700 font-bold tracking-wide leading-tight mb-5'>Data visualization</h2>

        <div className='mb-16'>
          <h3 className='text-[24px] text-grey-700 font-bold tracking-wide leading-tight mb-3'>Project budgets</h3>
          <p className='text-[24px] text-grey-700 tracking-normal leading-wide mb-5'>Budgets are reported in various currencies. In this tool, budgets have been converted into two global standard currencies (USD and EUR) for comparison across projects. Currency exchange rates were last sourced from [source] on [date].</p>
          <p className='text-[24px] text-grey-700 tracking-normal leading-wide mb-5'>Some projects do not report a budget and therefore appear as ‘Unspecified’ in the tool. The total budget figures listed for Partners are sums of all known associated project budgets, meaning that the true total budget for that Partner’s projects may in fact be higher than what’s displayed if some of the budgets are unknown or lower when they are a part of projects with many partners.</p>
        </div>

        <div className='mb-16'>
          <h3 className='text-[24px] text-grey-700 font-bold tracking-wide leading-tight mb-3'>Project beneficiaries</h3>
          <p className='text-[24px] text-grey-700 tracking-normal leading-wide mb-5'>Project beneficiary data is collected in two ways. Target Beneficiary types are frequently reported and appear in Project Detail views in the tool. Beneficiary counts, used in Project and Partner list views, are less commonly reported and have an associated Beneficiary Unit that is recorded separately from Target Beneficiary types. Note that Beneficiary Units may represent individual or multiple people, such as Individuals, Farmers, Households, and more. In the tool, any projects which include multiple-person Beneficiary Units are marked with a disclaimer.</p>
          <p className='text-[24px] text-grey-700 tracking-normal leading-wide mb-5'>The number and type of beneficiaries for a project are not always identifiable and may appear as ‘Unspecified’ in the tool. The Total Beneficiary counts listed for Partners are sums of all known associated project beneficiary counts, meaning that the true total beneficiary count for that Partner’s projects may in fact be higher than what’s displayed if some of the beneficiary counts are unknown.</p>
        </div>

        <div className='mb-16'>
          <h3 className='text-[24px] text-grey-700 font-bold tracking-wide leading-tight mb-3'>Estimated project locations</h3>
          <p className='text-[24px] text-grey-700 tracking-normal leading-wide mb-5'>In some cases the precise location of a project was unidentifiable during data collection so an estimated location was used, such as a country or region centroid. Since multiple projects may share the same estimated coordinates, these overlapping marks have been jittered into rings around the estimated location in order to reduce obscured data points on the map and reveal concentrations of project locations.</p>
        </div>

        <div className='mb-16'>
          <h3 className='text-[24px] text-grey-700 font-bold tracking-wide leading-tight mb-3'>Partner networks</h3>
          <p className='text-[24px] text-grey-700 tracking-normal leading-wide mb-5'>Projects may have multiple types of partners involved, including Primary, Funding, and Implementation, the lists of which may be incomplete, as data collection is ongoing. The partner networks in this tool visualize the known network for a single partner: all their known projects and all the known Primary Collaborators on those projects. These networks currently don’t include Funding or Implementation partners.</p>
        </div>

        <div className='mb-[100px]'>
          <p className='text-[24px] text-grey-700 tracking-normal leading-wide mb-5'>The data visualization was designed and developed in partnership with Periscopic.</p>
        </div>
      </div>
      <Footer />
    </div>
