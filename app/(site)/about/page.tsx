...
export default async function About() {
  ...
  return (
    <div className='relative pt-[80px] md:pt-[125px]'>
      ...
      <div className='relative w-full mb-10 md:mb-[100px]'>
        {content.heroImage && (
          <Image
      ...
      <div className='mb-[100px]'>
        ...
        <h2 className='max-w-[960px] mx-5 lg:mx-auto text-2xl md:text-[42px] text-grey-700 font-bold tracking-wide leading-tight mb-5'>Methods and Sources</h2>

        <div className='max-w-[960px] mx-5 lg:mx-auto mb-10 md:mb-16'>
          <h3 className='text-[18px] md:text-[24px] text-grey-700 font-bold tracking-wide leading-normal mb-3'>Identifying Actors and Actions</h3>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>A structured approach was employed utilizing two interconnected databases—one for actors and one for projects. Existing stakeholders maps were reviewed to identify key stakeholders in targeted countries, building the actors database. This database served as a foundation for identifying projects initiated by stakeholders. Project details were sourced from official websites, reports, or articles and collected through google forms. </p>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>These included partners, funders, budget, target value chains, beneficiaries, and specific methods implemented like on-farm adaptations (manure management, water harvesting, diversification, pest and disease management …) and beyond-farm adaptations (training, research, policy, finance …). Precise coordinates of the project locations were extracted as well to give a clear and detailed overview of each project’s scope.</p>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>As new projects were added, we identified new actors. This iterative process allows us to continually update the databases, and ensure the inclusion of as many projects as possible related to agricultural adaptations to a changing climate.</p>
        </div>

        <div className='max-w-[960px] mx-5 lg:mx-auto mb-16 md:mb-24'>
          <h3 className='text-[18px] md:text-[24px] text-grey-700 font-bold tracking-wide leading-normal mb-3'>Defining Actions, Impact Pathways, and Indicators</h3>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>To define key adaptation actions, the approximately 80 investments listed in the 10 Climate-Smart Agriculture Investment Plans (CSAIPs) were classified into broad, distinct categories through a systematic analysis of the activities included. An impact pathway was drawn out for each broad category of investment based on the scientific literature and project documents. Candidate indicators for each impact pathway were identified from the CSAIPs and major indicator compilations, enabling the alignment of specific indicators with each impact pathway. The result was a streamlined and relevant set of actions, impact pathways, and indicators that can kickstart the development of improved adaptation tracking plans and implementation.</p>
        </div>

        <h2 className='max-w-[960px] mx-5 lg:mx-auto text-2xl md:text-[42px] text-grey-700 font-bold tracking-wide leading-tight mb-5'>Data visualization</h2>

        <div className='max-w-[960px] mx-5 lg:mx-auto mb-10 md:mb-16'>
          <h3 className='text-[18px] md:text-[24px] text-grey-700 font-bold tracking-wide leading-normal mb-3'>Project budgets</h3>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>Budgets are reported in various currencies. In this tool, budgets have been converted into two global standard currencies (USD and EUR) for comparison across projects. Currency exchange rates were last sourced from [source] on [date].</p>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>Some projects do not report a budget and therefore appear as ‘Unspecified’ in the tool. The total budget figures listed for Partners are sums of all known associated project budgets, meaning that the true total budget for that Partner’s projects may in fact be higher than what’s displayed if some of the budgets are unknown or lower when they are a part of projects with many partners.</p>
        </div>

        <div className='max-w-[960px] mx-5 lg:mx-auto mb-10 md:mb-16'>
          <h3 className='text-[18px] md:text-[24px] text-grey-700 font-bold tracking-wide leading-normal mb-3'>Project beneficiaries</h3>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>Project beneficiary data is collected in two ways. Target Beneficiary types are frequently reported and appear in Project Detail views in the tool. Beneficiary counts, used in Project and Partner list views, are less commonly reported and have an associated Beneficiary Unit that is recorded separately from Target Beneficiary types. Note that Beneficiary Units may represent individual or multiple people, such as Individuals, Farmers, Households, and more. In the tool, any projects which include multiple-person Beneficiary Units are marked with a disclaimer.</p>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>The number and type of beneficiaries for a project are not always identifiable and may appear as ‘Unspecified’ in the tool. The Total Beneficiary counts listed for Partners are sums of all known associated project beneficiary counts, meaning that the true total beneficiary count for that Partner’s projects may in fact be higher than what’s displayed if some of the beneficiary counts are unknown.</p>
        </div>

        <div className='max-w-[960px] mx-5 lg:mx-auto mb-10 md:mb-16'>
          <h3 className='text-[18px] md:text-[24px] text-grey-700 font-bold tracking-wide leading-normal mb-3'>Estimated project locations</h3>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>In some cases the precise location of a project was unidentifiable during data collection so an estimated location was used, such as a country or region centroid. Since multiple projects may share the same estimated coordinates, these overlapping marks have been jittered into rings around the estimated location in order to reduce obscured data points on the map and reveal concentrations of project locations.</p>
        </div>

        <div className='max-w-[960px] mx-5 lg:mx-auto mb-10 md:mb-16'>
          <h3 className='text-[18px] md:text-[24px] text-grey-700 font-bold tracking-wide leading-normal mb-3'>Partner networks</h3>
          <p className='text-[18px] md:text-[24px] text-grey-700 tracking-normal leading-[30px] md:leading-[40px] mb-5'>Projects may have multiple types of partners involved, including Primary, Funding, and Implementation, the lists of which may be incomplete, as data collection is ongoing. The partner networks in this tool visualize the known network for a single partner: all their known projects and all the known Primary Collaborators on those projects. These networks currently don’t include Funding or Implementation partners.</p>
        </div>
