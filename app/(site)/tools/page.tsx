    ...
    <div className='relative pt-[125px]'>
      ...
      <div className='mb-[100px]'>
        ...
        <div className='max-w-[960px] mx-auto mb-16'>
          ...
          <p className='text-[24px] text-grey-700 tracking-normal leading-[40px] mb-5'>To aid in this process, a <a href="https://drive.google.com/drive/folders/1B4_GL_mRWpKP8lRh-LoNGSFXjOVwB9Sr" target='_blank' rel='noopener'>repository of indicators</a> has been developed. This has been compiled from multiple data sources, such as donor project frameworks, investment M&E plans, or national adaptation systems, among others. The repository offers a range of indicators matched to different stages and elements of select adaptation impact pathways. While the repository is not comprehensive, as some elements of some impact pathways may not be covered, it provides a starting point for organizations to identify what is most relevant to their specific adaptation tracking needs.</p>
