  ...
  return (
    <div className='relative pt-[125px]'>
      <div className='max-w-[960px] mx-auto mb-[100px]'>
        ...
        <h4 className='text-[42px] text-grey-700 font-bold tracking-wide leading-tight'>The development of comprehensive tracking plans is vital for evaluating adaptation effectiveness.</h4>
      </div>
